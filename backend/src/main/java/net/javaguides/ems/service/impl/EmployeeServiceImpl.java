...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public EmployeeDto updateEmployee(Long employeeId, EmployeeDto updatedEmployee) {
        ...
        if (updatedEmployee != null && updatedEmployee.getRole().equals(null)) {
...
//    @Override
//    public EmployeeDto getDataByEmailIdAndRole(String emailId, String role) {
//        Employee employee = employeeRepository.findAll(emailId)
//    }
